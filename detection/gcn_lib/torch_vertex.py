...
class WindowGrapher(nn.Module):
    ...
    def __init__(
        ...
        Hp = int(np.ceil(H / self.windows_size)) * self.windows_size
        Wp = int(np.ceil(W / self.windows_size)) * self.windows_size
        ...
        if self.shift_size > 0:
            ...
            img_mask = torch.zeros((1, 1, Hp, Wp))
    ...
    def _merge_pos_attn(self, batch_size):
        ...
        return self.relative_pos.repeat(nW*batch_size,1,1) + self.attn_mask.repeat(batch_size, 1, 1) # B, N, N
