...
parser.add_argument(
    ...
    action="store_true",
    default=False,
    help="Whether to disable logging to wandb - primarily for debugging purposes",
)
parser.add_argument(
    "--wandb-project-name",
    type=str,
    default="WiGNext-Init",
)
parser.add_argument(
...
parser.add_argument(
    ...
    action="store_true",
    default=False,
    help="whether to load the model strictly. This should be false when loading with a different window size.",
)

parser.add_argument("--attn-ratio", type=float, default=1.0, help="attention ratio")
parser.add_argument("--knn", default=9, type=int)
parser.add_argument("--use-reduce-ratios", type=int2bool, default=0)  # 1 == True
parser.add_argument("--img-size", default=224, type=int)
parser.add_argument("--window-size", default=8, type=int)
