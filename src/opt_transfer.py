...
def get_args_parser(add_help=True):
    ...
    parser = argparse.ArgumentParser(
        description="Transfer Learning Training", add_help=add_help
    )

    parser.add_argument("--model-type", type=str, help="model name")
    parser.add_argument(
        "-b",
        "--batch-size",
        default=32,
    ...
    parser.add_argument("--window-size", type=int, default=8, help="wignet window size")
    parser.add_argument(
        "-j",
        "--workers",
        default=16,
    ...
    parser.add_argument("--dataset", type=str, help="Source dataset.")

    parser.add_argument("--checkpoint", default="", type=str, help="path of checkpoint")
    parser.add_argument(
        "--root", type=str, default="/scratch/dataset", help="Dataset root folder."
    )
    parser.add_argument(
        "--loss", default="cross_entropy", type=str, choices=["cross_entropy", "nll"]
    )

    parser.add_argument("--use-shift", type=int2bool, default=0)  # 1 == True
    parser.add_argument("--adapt-knn", type=int2bool, default=0)  # 1 == True
    parser.add_argument("--freezed", type=int2bool, default=1)  # 1 == True
    parser.add_argument("--crop-size", default=None, type=int)
    parser.add_argument("--knn", default=9, type=int)
    parser.add_argument("--pos-embed-mode", type=str, default="interpolate-bili")
    parser.add_argument("--wignn-vig-pred-dropout", default=0.0, type=float)
    ...
    parser.add_argument("--profile-model-save-path", default=None, type=str)
